...
function App() {
  ...
  const hasData = trades.length > 0 || (orderBook && (orderBook.bids?.length > 0 || orderBook.asks?.length > 0));
  ...
  return (
    <ErrorBoundary>
      <div className="app">
        <ErrorBoundary>
          {showSkeletons ? <HeaderSkeleton /> : <Header currentPrice={currentPrice} />}
        </ErrorBoundary>
        <div className="app-main-content">
          ...
          <ErrorBoundary>
            <div className="app-section-chart">
              {showSkeletons ? <CandlestickChartSkeleton /> : <CandlestickChart />}
            </div>
          </ErrorBoundary>
          <ErrorBoundary>
